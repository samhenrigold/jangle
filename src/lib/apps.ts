...
// names embedded.
const APP_COLS =
  'id, app_store_id, bundle_id, app_store_name, display_name, copyright, icon_url, oldest_icon_sha256, large_icon_sha256, large_icon_px, genre_id, developer_id, developers!apps_developer_id_fkey(artist_name), genres!apps_genre_id_fkey(genre_name)';
